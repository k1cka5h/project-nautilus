...
module "network" {
  source = "git::ssh://git@github.com/nautilus/terraform-modules.git//modules/networking?ref=v1.4.0"
...
module "database" {
  source = "git::ssh://git@github.com/nautilus/terraform-modules.git//modules/database/postgres?ref=v1.4.0"
...
module "aks" {
  source = "git::ssh://git@github.com/nautilus/terraform-modules.git//modules/compute/aks?ref=v1.4.0"
