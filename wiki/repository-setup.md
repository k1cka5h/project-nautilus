...
# Apply for real
bash setup/scripts/apply-repo-config.sh myorg portal-infra setup/configs/product-team.json
```
...
```bash
bash setup/scripts/apply-repo-config.sh myorg myorg-infra-python setup/configs/construct-library.json
```
