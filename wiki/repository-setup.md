...
# Apply for real
bash setup/scripts/apply-repo-config.sh k1cka5h portal-infra setup/configs/product-team.json
```
...
```bash
bash setup/scripts/apply-repo-config.sh k1cka5h k1cka5h-infra-python setup/configs/construct-library.json
```
