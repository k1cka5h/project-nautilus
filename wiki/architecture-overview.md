...
└─────────────────────────┬───────────────────────────────────────┘
                           ...
                           ▼
┌─────────────────────────────────────────────────────────────────┐
│  terraform-modules  (myorg/terraform-modules — private)         │
│                                                                  │
...
| Construct libraries (all five languages) | | ✅ |
...
Product teams cannot change the key.
...
identical. Releasing `myorg-infra==1.5.0` requires cutting `v1.5.0` in the module
