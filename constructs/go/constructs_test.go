...
import (
	...
	infra "github.com/myorg/infra-go"
...
func TestNetworkConstruct_ModuleSource(t *testing.T) {
	...
	const wantSrc = "git::ssh://git@github.com/myorg/terraform-modules.git//modules/networking?ref=v1.4.0"
	if src != wantSrc {
...
func TestDatabaseConstruct_ModuleSource(t *testing.T) {
	...
	const wantSrc = "git::ssh://git@github.com/myorg/terraform-modules.git//modules/database/postgres?ref=v1.4.0"
	if src != wantSrc {
		t.Errorf("module source = %q, want %q", src, wantSrc)
	}
}
...
func TestAksConstruct_ModuleSource(t *testing.T) {
	...
	const wantSrc = "git::ssh://git@github.com/myorg/terraform-modules.git//modules/compute/aks?ref=v1.4.0"
	if src != wantSrc {
		t.Errorf("module source = %q, want %q", src, wantSrc)
	}
}
